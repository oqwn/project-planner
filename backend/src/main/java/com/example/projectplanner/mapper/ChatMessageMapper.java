...
public interface ChatMessageMapper {
    ...
    @Insert("INSERT INTO chat_messages (id, project_id, sender_id, content, type, reply_to_message_id, mentions, attachment_ids, created_at, updated_at, is_deleted) " +
            "VALUES (#{id}, #{projectId}, #{senderId}, #{content}, #{type}::message_type, #{replyToMessageId}, #{mentions, typeHandler=org.apache.ibatis.type.ArrayTypeHandler}, #{attachmentIds, typeHandler=org.apache.ibatis.type.ArrayTypeHandler}, #{createdAt}, #{updatedAt}, #{isDeleted})")
